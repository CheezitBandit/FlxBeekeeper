...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/bee.png", __ASSET__assets_images_bee_png);
		type.set ("assets/images/bee.png", AssetType.IMAGE);
		...
		className.set ("assets/images/hive.png", __ASSET__assets_images_hive_png);
		type.set ("assets/images/hive.png", AssetType.IMAGE);
		className.set ("assets/images/honeycomb.png", __ASSET__assets_images_honeycomb_png);
		type.set ("assets/images/honeycomb.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/hive.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/honeycomb.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_bee_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_hive_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_honeycomb_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/bee.png") #if display private #end class __ASSET__assets_images_bee_png extends lime.graphics.Image {}
...
@:image("assets/images/hive.png") #if display private #end class __ASSET__assets_images_hive_png extends lime.graphics.Image {}
@:image("assets/images/honeycomb.png") #if display private #end class __ASSET__assets_images_honeycomb_png extends lime.graphics.Image {}
